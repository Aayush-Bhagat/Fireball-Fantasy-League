...
export const playerGamesStats = pgTable(
	"player_games_stats",
	{
		...
		strikeoutsBatted: integer("strikeouts_batted"),
		hitByPitch: integer("hit_by_pitch"),
		singles: integer("singles"),
		doubles: integer("doubles"),
		triples: integer("triples"),
		oneHr: integer("one_hr"),
		twoHr: integer("two_hr"),
		threeHr: integer("three_hr"),
		grandSlams: integer("grand_slams"),
		totalBases: integer("total_bases"),
		sacFlies: integer("sac_flies"),
		startHits: integer("start_hits"),
		starsUsedBatting: integer("stars_used_batting"),
		...
		bobbles: integer("bobbles"),
		battersFaced: integer("batters_faced"),
		pitches: integer("pitches"),
		strikes: integer("strikes"),
		balls: integer("balls"),
		beanBalls: integer("bean_balls"),
		hitsAllowed: integer("hits_allowed"),
		singlesAllowed: integer("singles_allowed"),
		doublesAllowed: integer("doubles_allowed"),
		triplesAllowed: integer("triples_allowed"),
		homeRunsAllowed: integer("home_runs_allowed"),
		inheritedRuns: integer("inherited_runs"),
		starPitches: integer("star_pitches"),
		starsUsedPitching: integer("stars_used_pitching"),
