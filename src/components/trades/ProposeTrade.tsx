		...
		<div className="max-w-6xl mx-auto px-6 py-10 bg-white rounded-xl shadow-md space-y-6 mt-10">
			...
			<div className="flex flex-col md:flex-row gap-6">
				...
				<div className="w-full md:w-1/2 border p-4 rounded-lg bg-orange-50">
					<div className="flex justify-between items-center mb-4">
						...
						>
							<SelectTrigger className="w-[180px] border bg-gray-50 border-gray-300 text-black">
			...
			<div className="flex justify-end gap-4">
				...
				<Button
					...
					className="px-5 py-2 bg-purple-700 text-white rounded-sm hover:bg-purple-800"
				>
					Confirm Trade
				</Button>
			</div>
