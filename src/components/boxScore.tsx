...
export const BoxScore = async ({ boxScore }: Props) => {
    ...
    const renderBattingTable = (
        ...
        const totals = {
            ...
            walks: sumNonNullable(stats, "walks"),
                        ...
                        <tbody>
                            {stats.map((p, idx) => (
                                ...
                                >
                                    ...
                                    <TableCell value={formatStat(p.putout)} />
                            ...
                            <tr className="bg-slate-50 font-bold text-slate-800">
                                ...
                                <TableCell
                                    value={sumNullable(stats, "putout")}
                                />
