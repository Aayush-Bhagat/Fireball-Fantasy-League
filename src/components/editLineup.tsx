...
export default function EditLineup({ lineupData, rosterData, token }: Props) {
    ...
    const handleSave = () => {
        saveLineup(selectedPlayers, token)
            .then(() => toast("Lineup saved successfully!"))
            .catch((error) => console.error("Error saving lineup:", error));
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-violet-50 to-white px-6 py-6">
            <div className="flex flex-col md:flex-row items-start justify-center gap-10">
                <div className="relative">
                    <img
                        ...
                        width={700}
                        height={500}
                        className="rounded-xl shadow border border-violet-300"
                    />
